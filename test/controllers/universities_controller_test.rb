...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { univ_addr: @university.univ_addr, univ_id: @university.univ_id, univ_name: @university.univ_name }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { univ_addr: @university.univ_addr, univ_id: @university.univ_id, univ_name: @university.univ_name }
    assert_redirected_to university_path(assigns(:university))
  end
